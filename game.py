...
ball = Picture('bowling.png', 160, 200, 50, 50)
platform = Picture('hurricane.png', platform_x, platform_y, 100, 30)
start_x = 5
start_y = 5
banyak = 9
...
for j in range(3):
  ...
  for i in range (banyak):
      d = Picture('pin.png',x, y, 50, 50)
      monsters.append(d)
      x = x + 55
  banyak = banyak - 1

pygame.mixer.init()
pygame.mixer.music.load('phonk.ogg')
